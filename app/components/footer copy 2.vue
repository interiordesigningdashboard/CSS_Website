<template>
  <footer class="bg-gray-800 text-white pt-12 pb-4 relative">
    <div class="mx-auto px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
        ...
        <div class="lg:col-span-2 lg:pr-4">
          ...
          <!-- Newsletter Signup -->
          <div class="mb-8">
            <h4 class="text-lg font-semibold mb-3 text-white">Stay Updated</h4>
            <form @submit.prevent="handleNewsletterSubmit" class="mb-4">
              <div class="flex flex-col sm:flex-row gap-2 mb-2">
                <input 
                  ...
                  class="flex-1 px-4 py-3 border border-gray-600 rounded-lg sm:rounded-l-lg sm:rounded-r-none bg-gray-600 text-white text-sm placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:bg-gray-500 transition-all duration-300"
                >
                <button 
                  type="submit" 
                  :disabled="isSubscribing"
                  class="px-4 py-3 bg-gradient-to-r from-orange-500 to-pink-500 border-none rounded-lg sm:rounded-l-none sm:rounded-r-lg text-white cursor-pointer transition-all duration-300 hover:from-orange-600 hover:to-pink-600 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center min-w-[50px]"
                >
              ...
              <p v-if="newsletterMessage" 
                 class="text-xs mt-2 p-2 rounded border"
                 :class="newsletterStatus === 'success' 
        ...
        <div class="lg:col-start-4">
          ...
          <div class="flex flex-col gap-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="text-gray-300 m-0 text-sm leading-snug">123 Creative Avenue</p>
                <p class="text-gray-300 m-0 text-sm leading-snug">Design District, NY 10001</p>
              </div>
            </div>
      ...
      <div class="border-t border-white/10 pt-6">
        <div class="flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-6">
          <!-- Copyright -->
          <div>
            <p class="text-gray-400 text-sm m-0">&copy; {{ currentYear }} ColorCraft Signage Solutions. All rights reserved.</p>
          </div>
    ...
    <button 
      ...
      @click="scrollToTop"
      class="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-orange-500 to-pink-500 border-none rounded-full text-white cursor-pointer transition-all duration-300 z-50 shadow-lg shadow-orange-500/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-500/50"
      title="Back to top"
    >
