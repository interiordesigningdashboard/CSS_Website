  ...
  <section id="about" class="py-20 bg-gray-50" ref="aboutSection">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
        ...
        <div class="lg:pr-8">
          ...
          <p class="text-lg text-gray-600 mb-6 leading-relaxed">
            With over a decade of experience in the signage and printing
            industry, Colors and Signage Solution has established itself as a
            leader in innovative visual solutions. We combine cutting-edge
            technology with artistic creativity to deliver exceptional results
            that exceed our clients' expectations.
          </p>

          <p class="text-lg text-gray-600 mb-8 leading-relaxed">
            Our team of skilled designers, fabricators, and project managers
            work collaboratively to ensure every project is completed with
            precision, on time, and within budget. We pride ourselves on our
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div
                class="w-10 h-10 bg-gradient-to-br from-green-500 to-green-400 rounded-full flex items-center justify-center text-white"
              >
        ...
        <div class="flex flex-col gap-8">
          ...
          >
            ...
            >
              <div
                class="text-4xl font-extrabold bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent mb-2"
              >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          >
            <div class="relative mb-6">
              <div
                class="w-48 h-48 mx-auto rounded-full overflow-hidden shadow-lg ring-4 ring-white group-hover:ring-blue-100 transition-all duration-300"
              >
                <img
              ...
              <!-- Decorative Ring -->
              <div
                class="absolute inset-0 w-48 h-48 mx-auto rounded-full border-4 border-blue-200 opacity-0 group-hover:opacity-100 scale-110 group-hover:scale-125 transition-all duration-300"
              ></div>
            </div>

            <div
              class="bg-white rounded-2xl p-8 shadow-sm border group-hover:shadow-lg group-hover:border-blue-100 transition-all duration-300"
            >
              <h4 class="text-2xl font-bold text-gray-900 mb-2">
                {{ leadership.ceo.name }}
              </h4>
              <p class="text-blue-600 font-semibold mb-4 text-lg">
                Managing Director
              </p>
          ...
          >
            ...
            >
              ...
              <p class="text-orange-600 font-semibold mb-4 text-lg">
    ...
    <div class="relative overflow-hidden mt-8">
      ...
      >
        ...
        <!-- Fade edges -->
        <div
          class="absolute top-0 left-0 w-24 h-full bg-gradient-to-r from-current to-transparent opacity-30 pointer-events-none z-10"
        ></div>
        <div
          class="absolute top-0 right-0 w-24 h-full bg-gradient-to-l from-current to-transparent opacity-30 pointer-events-none z-10"
        ></div>
    ...
    return {
      ...
      leadership: {
        ceo: {
          ...
          photo: "/CSS_Website/CEO.png",
          description:
            "With over 15 years of experience in the signage industry, Balasubramaniam leads Colors & Signage Solution with a vision for innovation and excellence. His strategic leadership has positioned the company as a market leader.",
          social: {
    ...
    startGradientRotation() {
      ...
      this.gradientTimer = setInterval(() => {
        this.currentGradientIndex =
          (this.currentGradientIndex + 1) % this.marqueeGradients.length;
      }, 3000);
    },
  },
};
