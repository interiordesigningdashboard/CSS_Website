<template>
  <footer class="bg-gray-800 text-white pt-12 pb-4 relative">
    <div class="mx-auto px-8">
      <!-- Main Footer Content -->
      <div
        class="grid grid-cols- md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-8"
      >
        <!-- Company Info -->
        ...
        <div>
          ...
          <div class="flex flex-col gap-4">
            <div class="flex items-start gap-3">
              <i
                class="fas fa-map-marker-alt text-orange-500 text-base mt-0.5 w-4 flex-shrink-0"
              ></i>
              <div class="flex-1">
                <a
                ...
                >
                  No.14, SFNo.353, 4B, Kovur, Rajiv Gandhi Nagar, Kundrathur,
                  Chennai, Tamil Nadu 600128
                </a>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              <i
                class="fas fa-phone text-orange-500 text-base mt-0.5 w-4 flex-shrink-0"
              ></i>
              <div class="flex-1">
                <a
                  href="tel:+9199625 00715"
                  class="text-gray-300 no-underline transition-colors duration-300 text-sm hover:text-blue-400"
                  >+91 99625 00715</a
                >
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              <i
                class="fas fa-envelope text-orange-500 text-base mt-0.5 w-4 flex-shrink-0"
              ></i>
              <div class="flex-1">
                <a
                  href="mailto:info@colorsandsignage.co.in"
                  class="text-gray-300 no-underline transition-colors duration-300 text-sm hover:text-blue-400"
                  >info@colorsandsignage.co.in</a
                >
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              <i
                class="fas fa-clock text-orange-500 text-base mt-0.5 w-4 flex-shrink-0"
              ></i>
              <div class="flex-1">
                <p class="text-gray-300 m-0 text-sm leading-snug">
                  Mon-Fri: 9AM-6PM
                </p>
                <p class="text-gray-300 m-0 text-sm leading-snug">
                  Sat: 10AM-4PM
      ...
      <div class="border-t border-white/10 pt-6">
        <div
          class="flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-6"
        >
          <!-- Copyright -->
          <div>
            <p class="text-gray-400 text-sm m-0">
              &copy; {{ currentYear }}
              <span class="good-times">Colors & Signage Solutions.</span> All
              rights reserved.
            </p>
          </div>
    ...
    >
      <div
        class="bg-white rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col"
        @click.stop
      >
        <div
          class="flex justify-between items-center px-8 py-6 border-b border-gray-200 bg-gray-50"
        >
          ...
          <button
            @click="closeLegalModal"
            class="bg-none border-none text-2xl text-gray-500 cursor-pointer p-2 rounded-full transition-all duration-300 hover:bg-gray-200 hover:text-red-500"
          >
            <i class="fas fa-times"></i>
          </button>
        </div>
        <div
          class="px-8 py-8 overflow-y-auto flex-1 text-gray-800 leading-relaxed prose prose-sm max-w-none"
        >
        ...
        <div class="px-8 py-4 border-t border-gray-200 bg-gray-50 text-right">
          <button
            @click="closeLegalModal"
            class="bg-gray-500 text-white border-none px-6 py-3 rounded-lg cursor-pointer font-medium transition-colors duration-300 hover:bg-gray-600"
          >
            Close
          </button>
        </div>
      ...
      legalLinks: [
        {
          ...
          content: `
            ...
            <h5>Contact Us</h5>
            <p>If you have questions about this Privacy Policy, please contact us at info@colorsandsignage.co.in</p>
          `,
        },
        {
