<template>
  <section id="home" class="relative min-h-screen flex flex-col justify-center items-center text-center overflow-hidden bg-gradient-to-br from-blue-50 via-pink-50 to-orange-50">
  ...
  <span class="inline-block" style="min-height: 1.2em; padding:px">
    ...
    >|</span>
      ...
      <p 
        ...
        :class="{ 'opacity-100 translate-y-0': subtitleVisible, 'opacity-0 translate-y-5': !subtitleVisible }"
      >
        {{ subtitle }}
      </p>
      ...
      <div 
        ...
        :class="{ 'opacity-100 translate-y-0': actionsVisible, 'opacity-0 translate-y-8': !actionsVisible }"
      > 
        <a 
          href="#contact" 
    ...
    <div 
      ...
      @click="scrollToNext"
    >
      <div class="w-8 h-8 sm:w-10 sm:h-10 border-2 border-blue-600 rounded-full flex items-center justify-center animate-bounce">
        <i class="fas fa-chevron-down text-blue-600 text-xs sm:text-sm"></i>
      </div>
      <span class="text-xs sm:text-sm text-gray-700 font-medium">Scroll to explore</span>
    </div>
  </section>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      backgroundShapes: [
        {
          classes: 'w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-blue-500/10 to-orange-500/10',
          style: {
            top: '20%',
            left: '10%',
        ...
        {
          classes: 'w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-yellow-400/10 to-red-500/10',
          style: {
            top: '60%',
            left: '17%',
            animation: 'float 6s ease-in-out infinite'
        ...
        {
          classes: 'w-32 h-32 md:w-40 md:h-40 bg-gradient-to-br from-emerald-500/10 to-pink-500/10',
          style: {
            top: '60%',
            right: '15%',
        ...
        {
          classes: 'w-32 h-32 md:w-40 md:h-40 bg-gradient-to-br from-blue-500/10 to-purple-500/10',
          style: {
            top: '40%',
            right: '50%',
        ...
        {
          classes: 'w-32 h-32 md:w-40 md:h-40 bg-gradient-to-br from-indigo-500/10 to-fuchsia-500/10',
          style: {
            top: '10%',
            right: '10%',
            borderRadius: '35% 70% 60% 30% / 30% 30% 70% 70%',
        ...
        {
          classes: 'w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-orange-500/10 to-blue-500/10',
          style: {
            bottom: '30%',
            left: '5%',
